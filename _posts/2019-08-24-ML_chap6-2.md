---
title:  "[Handson ML] 배깅(Bagging)과 페이스팅(Pasting) - 앙상블"
...
앞서 포스팅한 [투표 기반 분류기](https://yganalyst.github.io/ml/ML_chap6-1/)에서는 각기 다른 훈련 알고리즘을 조합하여 새로운 분류기를 생성하는 것이였다. 이러한 앙상블 모형을 만드는 다른 방법은 같은 알고리즘을 사용하지만, 훈련 세트의 서브셋을 무작위로 구성하여 분류기를 각기 다르게 학습시키는 방법이 있다.  
