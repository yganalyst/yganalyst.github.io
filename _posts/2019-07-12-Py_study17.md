---
title:  "[Python 기초 17] 파이썬 프로그래밍 - 외장함수"
...
앞서 배운 파이썬에 기본으로 내장된 [내장 함수](https://yganalyst.github.io/study/Py_study16/)외에도, 전 세계 파이썬 사용자들이 만든 유용한 프로그램들을 모아 놓은것이 바로 파이썬 라이브러리이다.  
