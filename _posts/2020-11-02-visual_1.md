...
excerpt: "matplotlib pyplot을 활용하여 데이터를 시각화 해보자"
toc: true
toc_sticky: true
header:
...
![png](/assets/images/visual_logo.png){: width="90%" height="90%"} 
...
산점도는 x값과 y값을 2차원 평면상에 뿌리는 것을 의미한다. `scatter`함수를 사용해도 되고 그냥 `plot`함수에서 marker만 그려도 된다(개인적으로는 `plot`함수만 씀)  
...
![png](/assets/images/visual/1/output_24_0.png)
...
![png](/assets/images/visual/1/output_25_0.png)
...
![png](/assets/images/visual/1/output_30_0.png)
