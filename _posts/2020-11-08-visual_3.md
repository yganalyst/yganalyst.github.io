...
![png](/assets/images/visual/3/radar_chart.png){: .align-center}{: width="60%" height="60%"} 
...
위는 이 포스팅의 핵심인 Radar chart를 그리는 함수이다. [여기를 참고](https://python-graph-gallery.com/390-basic-radar-chart/)  
그리는 방법의 핵심은 다음과 같다.  
