...
이번 포스팅은 image classification problem에 대한 내용이다.  
그리고 이를 해결하기 위한 기존의 접근 방식인 Nearest Neighbor와 Linear classifier에 대한 내용도 포함된다.  
...
![PNG](/assets/images/cs231n/1/pc_6.PNG){: .align-center}{: width="50%" height="50%"}  
