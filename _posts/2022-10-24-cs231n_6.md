...
![png](/assets/images/cs231n/6/early_stop.png){: .align-center}{: width="80%" height="80%"}  
...
![png](/assets/images/cs231n/6/dropout.PNG){: .align-center}{: width="80%" height="80%"}  
...
![png](/assets/images/cs231n/6/dropout_1.PNG){: .align-center}{: width="80%" height="80%"}  
...
![png](/assets/images/cs231n/6/stochastic_depth.PNG){: .align-center}{: width="80%" height="80%"}  
...
![png](/assets/images/cs231n/6/cutout.png){: .align-center}{: width="70%" height=70%"}  
...
![png](/assets/images/cs231n/6/batch_norm_3.PNG){: .align-center}{: width="70%" height=70%"}  
...
Batch Normalization을 이용하면 **Layer 별로 zero-centered를 유지**할 수 있기 때문에 다양한 장점이 생긴다.  
...
거의 모든 면에서 장점을 가지지만, **test할때 training data의 mean과 variance를 그대로 사용하는 것**에서 몇가지 약점이 생긴다.  
...
![png](/assets/images/cs231n/6/opt_2.PNG){: .align-center}{: width="80%" height=80%"}  
...
![png](/assets/images/cs231n/6/opt_3.PNG){: .align-center}{: width="80%" height=80%"}  
...
![png](/assets/images/cs231n/6/opt_7.png){: .align-center}{: width="80%" height=80%"}  
...
![png](/assets/images/cs231n/6/opt_8.png){: .align-center}{: width="80%" height=80%"}  

![png](/assets/images/cs231n/6/opt_9.png){: .align-center}{: width="80%" height=80%"}  
...
![png](/assets/images/cs231n/6/opt_10.png){: .align-center}{: width="80%" height=80%"}  
...
![png](/assets/images/cs231n/6/opt_11.png){: .align-center}{: width="80%" height=80%"}  
