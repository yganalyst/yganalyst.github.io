---
title:  "[SQL] 2과목 1장 - SQL 활용(2) JOIN, 계층형 질의, 셀프 조인, 서브쿼리, 그룹함수, 윈도우 함수, DCL, 절차형 SQL"
...
![png](/assets/images/sql/sqld/chapter2_3_1.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_2.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_3.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_6.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_7.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_8.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_9.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_14.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_15.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_16.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_17.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_18.png){: .align-center}{: width="80%" height="80%"} 
...
![png](/assets/images/sql/sqld/chapter2_3_19.png){: .align-center}{: width="80%" height="80%"} 
...
**`AVG`**
  ...
  - 예제 : EMP 테이블에서 같은 매니저를 두고 있는 사원들의 평균 SALARY를 구하는데, 조건은 같은 매니저 내에서 자기 바로 앞의 사번과 바로 뒤의 사번인 직원만을 대상으로 한다.
    ...
    ![png](/assets/images/sql/sqld/chapter2_3_20.png){: .align-center}{: width="80%" height="80%"} 
...
**`COUNT`**
  ...
  - 예제 : 사원들을 급여 기준으로 정렬하고, 본인의 급여보다 50 이하가 적거나 150 이하로 많은 급여를 받는 인원수를 출력
    ...
    ![png](/assets/images/sql/sqld/chapter2_3_21.png){: .align-center}{: width="80%" height="80%"} 
...
**`FIRST_VALUE` (`MIN` 으로도 가능)**
  ...
  - 예제 : 부서별 직원들을 연봉이 높은 순서부터 정렬하고, 파티션 내에서 가장 먼저 나온 값 출력
    ...
    ![png](/assets/images/sql/sqld/chapter2_3_22.png){: .align-center}{: width="80%" height="80%"} 
...
**`LAG(가져올 컬럼, 몇번째 앞의 행을 가져올지, 데이터가 없어 NULL대신 입력할 값)`**
  ...
  - 몇번째 앞의 행을 가져올지 : 명시 안되어 있으면 DEFAULT는 1
    ...
    ![png](/assets/images/sql/sqld/chapter2_3_23.png){: .align-center}{: width="80%" height="80%"} 
...
**Procedure 생성 예제**
  - SCOTT 유저가 소유하고 있는 DEPT 테이블에 새로운 부서를 등록하는 Procedure를 작성
    ...
    ![png](/assets/images/sql/sqld/chapter2_3_26.png){: .align-center}{: width="80%" height="80%"} 
